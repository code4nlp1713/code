...
```
Where `uuid` is the unique identifier for each document in the FineWeb dataset, `label` is the annotation from the Mixtral model, and `label_human` is the label assigned by a human annotator.
### Dataset Overview:
...
- [3,840 non-financial documents](https://github.com/code4nlp1713/code/blob/main/nonfinancial_human_anno_doc.json) (negative class, label: 0)
